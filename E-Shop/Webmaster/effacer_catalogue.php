...
//mysql_query("Delete From produit Where refmagasin=$id");
$r=mysql_query("Delete From catalogue Where refproduit=$id");
       
?>
<SCRIPT LANGUAGE="JavaScript">
var obj="document.location.href=('index.php');";
setTimeout(obj,3); 
</SCRIPT><noscript><a href="login.html">ajax</a></noscript>
                  </div>  
