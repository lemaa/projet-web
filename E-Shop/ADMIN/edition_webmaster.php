...
$c=mysql_connect("localhost","root","") or die("erreur de connexion");
		...
		$r=mysql_query("UPDATE webmaster SET username='$username',password='$password',email='$email',tel='$tel' WHERE id=$id ");
...
$c=mysql_connect("localhost","root","") or die("erreur de connexion");
$base=mysql_select_db("sabra-fm") or die ("base non trouve");
$r=mysql_query("select * From webmaster Where id=$id");
while($l=mysql_fetch_array($r)){
  echo " <h2>Modifier webmaster : </h2>
   <div class=form>
         <form action=edition_webmaster.php?id=$l[id] method=post class=niceform>
