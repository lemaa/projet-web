...
$c=mysql_connect("localhost","root","") or die("erreur de connexion");
		...
		$r=mysql_query("INSERT INTO webmaster (username,password,email,tel) VALUES ('$username','$password','$email','$tel')");
    }     
?>
   ...
   <?php include("todolist.php"); ?>
    ...
    <div class="right_content">           
     ...
     <h2>Nouveau compte Admin : </h2>
         ...
         <div class="form">
         <form action="ajout_webmaster.php" method="post" class="niceform">
