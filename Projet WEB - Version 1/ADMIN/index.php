...
<?php include("header.php"); ?>
    ...
    <div class="right_content">           
     <br /><br /><br />
 <h2>Les Travaux à faire : </h2> 
                    
                    
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
    	<tr>
        	<th scope="col" class="rounded-company">Technicien</th>
            <th scope="col" class="rounded">sujet</th>
            <th scope="col" class="rounded">message</th>
            <th scope="col" class="rounded-q4">Fait</th>
        </tr>
    </thead>
        <tfoot>
    	<tr>
    ...
    <tbody>
		...
		$r=mysql_query("select * from todolist order by fait ASC");
